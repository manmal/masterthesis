...
\begin{figure}[H]
	\centering
	\subfloat[The initial graph state before MDS/spring model calculations]{
		\label{fig:screen_mds_1_initial}
		\includegraphics[width=0.3\textwidth]{figures/screen_mds_1_initial}
	}
	\hfill
	\subfloat[Graph state after 5 iterations on the seed nodes subset]{
...
\begin{figure}[H]
	...
	\hfill
	\subfloat[Graph state after 10 spring force iterations of all nodes]{
